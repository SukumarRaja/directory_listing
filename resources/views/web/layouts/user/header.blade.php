            ...
            <div class="col-md-6 col-8">
                <div class="site">
                    <div class="site__menu">
                        <a title="{{ __('Menu Icon') }}" href="#" class="site__menu__icon">
                            <i class="las la-bars la-24-black"></i>
                        </a>
                        <div class="popup-background"></div>
                        <div class="popup popup--left">
                            <a title="{{ __('Close') }}" href="#" class="popup__close">
                                <i class="las la-times la-24-black"></i>
                            </a><!-- .popup__close -->
                            <div class="popup__content">
                                @guest
                                <div class="popup__user popup__box open-form">
                                    <a title="{{ __('Login') }}" href="#" class="open-login">{{ __('Login') }}</a>
                                    <a title="{{ __('Sign Up') }}" href="#" class="open-signup">{{ __('Sign Up') }}</a>
                                </div>
                                @else
                                <div class="account">
                                ...
                                <div class="popup__destinations popup__box">
                                    <ul class="menu-arrow">
                                        <li>
                                            <a title="{{ __('Destinations') }}" href="#">{{ __('Destinations') }}</a>
                                            <ul class="sub-menu">
                                                <li><a href="#" title="{{ __('San Diego') }}">{{ __('San Diego') }}</a></li>
                                                <li><a href="#" title="{{ __('New York') }}">{{ __('New York') }}</a></li>
                                                <li><a href="#" title="{{ __('Los Angeles') }}">{{ __('Los Angeles') }}</a></li>
                                                <li><a href="#" title="{{ __('Chicago') }}">{{ __('Chicago') }}</a></li>
                                                <li><a href="#" title="{{ __('San Francisco') }}">{{ __('San Francisco') }}</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                ...
                                <div class="popup__menu popup__box">
                                    <ul class="menu-arrow">
                                        <li>
                                            <a title="{{ __('Demo') }}" href="#">{{ __('Demo') }}</a>
                                            <ul class="sub-menu">
                                        ...
                                        <li>
                                            <a title="{{ __('Place detail') }}" href="#">{{ __('Place detail') }}</a>
                                            <ul class="sub-menu">
                                        ...
                                        <li>
                                            <a title="{{ __('Page') }}" href="#">{{ __('Page') }}</a>
                                            <ul class="sub-menu">
                                        ...
                                        <li><a title="{{ __('Blog') }}" href="#">{{ __('Blog') }}</a></li>
                                        <li><a title="{{ __('Contact') }}" href="#">{{ __('Contact') }}</a></li>
                                    </ul>
                                </div><!-- .popup__menu -->
                            </div><!-- .popup__content -->
                    ...
                    <div class="site__brand">
                        <a title="{{ __('Logo') }}" href="#" class="site__brand__logo"><img src="http://localhost/golo/public/assets/images/assets/logo.png" alt="{{ __('Logo') }}"></a>
                    </div><!-- .site__brand -->
                    <div class="site__search layout-02">
                        <a title="{{ __('Close') }}" href="#" class="search__close">
            ...
            <div class="col-md-6 col-4">
                <div class="right-header align-right">
                    <div class="right-header__languages">
                        ...
                        <ul>
                            <li>
                                <a href="http://localhost/golo/public/language/fr" title="{{ __('French') }}">
                    ...
                    <div class="right-header__login">
                        <a title="{{ __('Login') }}" class="open-login" href="#">{{ __('Login') }}</a>
                    ...
                    <div class="popup popup-form">
                        ...
                        <ul class="choose-form">
                            <li class="nav-login"><a title="{{ __('Login') }}" href="#login">{{ __('Login') }}</a></li>
                            <li class="nav-signup"><a title="{{ __('Sign Up') }}" href="#register">{{ __('Sign Up') }}</a></li>
                        </ul>
                        <p class="choose-more">{{ __('Continue with') }} <a title="{{ __('Facebook') }}" class="fb" href="#">{{ __('Facebook') }}</a> {{ __('or') }} <a title="{{ __('Google') }}" class="gg" href="#">{{ __('Google') }}</a></p>
                        <p class="choose-or"><span>{{ __('Or') }}</span></p>
                        <div class="popup-content">

                            <form id="login" class="form-log form-content" action="#" method="POST">
                                @csrf
                                ...
                                <div class="choose-form mb-0">
                                    <a title="{{ __('Forgot password') }}" class="forgot_pass" href="#forgot_password">{{ __('Forgot password') }}</a>
                                </div>

                                <button type="submit" class="gl-button btn button w-100" id="submit_login">{{ __('Login') }}</button>
                            </form>

                            <form id="register" class="form-sign form-content" action="#" method="POST">
                                @csrf
                                ...
                                <div class="field-check">
                                    <label for="accept">
                                        ...
                                        {{ __('Accept the') }} <a title="{{ __('Terms') }}" href="#">{{ __('Terms') }}</a> {{ __('and') }} <a title="{{ __('Privacy Policy') }}" href="#">{{ __('Privacy Policy') }}</a>
                    ...
                    <div class="right-header__search">
                        <a title="{{ __('Search') }}" href="#" class="search-open">
                            <i class="las la-search la-24-black"></i>
                        </a>
                    </div>
                    <div class="right-header__button btn">
                        <a title="{{ __('Add place') }}" href="#">
