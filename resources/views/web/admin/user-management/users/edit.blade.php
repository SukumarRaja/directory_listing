                            ...
                            <div class="row gx-5">
                                <div class="col-md-6">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('firstName') is-invalid @enderror" id="firstName" name="firstName" placeholder="{{ __('Enter user first name') }}" value="{{ old('firstName', $user->first_name) }}" required>
                                            @error('firstName')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('lastName') is-invalid @enderror" id="lastName" name="lastName" placeholder="{{ __('Enter user last name') }}" value="{{ old('lastName', $user->last_name) }}">
                                            @error('lastName')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="{{ __('Enter user username') }}" value="{{ old('username', $user->username) }}" required>
                                                @error('username')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="{{ __('Enter user email address') }}" value="{{ old('email', $user->email) }}" required>
                                            @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control @error('roles') is-invalid @enderror" name="roles[]" id="roles" multiple>
                                                ...
                                                <option class="text-dark" value="{{ $role->id }}" @if((old('_token') && (is_array(old('role')) ? in_array($role->id, old('role')) : '') != null) || (old('_token') == null && in_array($role->id, $userRoles->toArray()) != null)) selected @endif>{{ $role->name }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                            @error('roles')
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-check form-check-primary">
                                                <label for="emailVerification" class="form-check-label">
                                                    <input type="checkbox" class="form-check-input" name="emailVerification" id="emailVerification" value="1" {{ ((old('emailVerification') == '1') || (($user->email_verified_at != null) && (old('_token') == null))) ? 'checked' : ''  }}>
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-check form-check-primary">
                                                <label for="isActive" class="form-check-label">
                                                    <input type="checkbox" class="form-check-input" name="isActive" id="isActive" value="1" {{ ((old('isActive') == '1') || (($user->is_active != null) && (old('_token') == null))) ? 'checked' : ''  }}>
                                                    {{ __('Is Active') }}
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group @error('password') is-invalid @enderror">
                                                <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" placeholder="{{ __('Enter user password') }}" autocomplete="current-password">
                            ...
                            <div class="row gx-5">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control @error('mobile') is-invalid @enderror" id="mobile" name="mobile" placeholder="{{ __('Enter user mobile number') }}" value="{{ old('mobile', $user->mobile) }}">
                                                @error('mobile')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="row px-3">
                                                <div class="form-check col">
                                                    <label class="form-check-label" for="m">
                                                        <input class="form-check-input @error('gender') is-invalid @enderror" type="radio" name="gender" id="m" value="m" {{ (old('gender', $user->gender) == 'm') ? 'checked' : ''  }}>
                                                        {{ __('Male') }}
                                                    </label>
                                                </div>
                                                <div class="form-check col">
                                                    <label class="form-check-label" for="f">
                                                        <input class="form-check-input @error('gender') is-invalid @enderror" type="radio" name="gender" id="f" value="f" {{ (old('gender', $user->gender) == 'f') ? 'checked' : ''  }}>
                                                        {{ __('Female') }}
                                                    </label>
                                                </div>
                                                <div class="form-check col">
                                                    <label class="form-check-label" for="o">
                                                        <input class="form-check-input @error('gender') is-invalid @enderror" type="radio" name="gender" id="o" value="o" {{ (old('gender', $user->gender) == 'o') ? 'checked' : ''  }}>
                                                        {{ __('Other') }}
                                                    </label>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control @error('pinCode') is-invalid @enderror" id="pinCode" name="pinCode" placeholder="{{ __('Enter user pincode') }}" value="{{ old('pinCode', $user->pin_code) }}">
                                            @error('pinCode')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('country') is-invalid @enderror" id="country" name="country" placeholder="{{ __('Enter user country') }}" value="{{ old('country', $user->country) }}">
                                            @error('country')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('state') is-invalid @enderror" id="state" name="state" placeholder="{{ __('Enter user state') }}" value="{{ old('state', $user->state) }}">
                                            @error('state')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('district') is-invalid @enderror" id="district" name="district" placeholder="{{ __('Enter user district') }}" value="{{ old('district', $user->district) }}">
                                            @error('district')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('postOffice') is-invalid @enderror" id="postOffice" name="postOffice" placeholder="{{ __('Enter user post office') }}" value="{{ old('postOffice', $user->post_office) }}">
                                            @error('postOffice')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
