                            ...
                            <div class="row gx-5">
                                <div class="col-12">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('roleName') is-invalid @enderror" id="roleName" name="roleName" placeholder="{{ __('Enter role name') }}" value="{{ old('roleName') }}" required autofocus>
                                            @error('roleName')
                                                    ...
                                                    <td class="py-2">
                                                        <div class="row px-3">
                                                            ...
                                                            <div class="form-check col @error('permissionIds') form-check-danger @enderror">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input" type="checkbox" value="{{ $permission->id }}" name="permissionIds[]" @if(is_array(old('permissionIds')) && in_array($permission->id, old('permissionIds'))) checked @endif>
                                                                    {{ $permission->name }}
                                                                </label>
                                                            </div>
                                                            @endif
